...
const APPLICATION_ERROR_MESSAGES: Record<string, string> = {
  ...
  invalid_allocations:
    'Writing commission and production credit must each total exactly 10,000 basis points.',
  invalid_premium: 'Enter a valid premium or deposit for this product line.',
  ...
  not_authorized: 'You do not have permission to create or update this application.',
