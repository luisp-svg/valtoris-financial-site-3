  ...
  return (
    <div className={`crm-ifd-detail${embedded ? ' crm-intake-assessment-detail' : ''}`}>
      ...
      <section className="crm-panel crm-ifd-detail-section" aria-labelledby="crm-ifd-snapshot-heading">
        ...
        <p className="crm-muted">
          Responses saved with this report card at submission. These are historical responses,
          not the household’s current CRM record. Only saved answers are shown.
        </p>
        {detail.submittedAnswers.length === 0 ? (
          <p className="crm-muted">No submitted answers were stored for this report card.</p>
        ) : (
          <dl className="crm-client-workspace-info-list">
