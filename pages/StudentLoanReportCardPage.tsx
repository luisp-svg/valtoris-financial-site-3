    ...
    <DiagnosticLanding
      ...
      samplePreview={
        <SpecializedSampleResultsPreview
          ...
          status={t('results', 'status.opportunities')}
          barsLabel={t('results', 'categories')}
          bars={[
            { label: t('results', 'category.status_stability'), score: 84 },
            { label: t('results', 'category.repayment_strategy'), score: 62 },
            { label: t('results', 'category.forgiveness_optimization'), score: 55 },
            { label: t('results', 'category.knowledge_structure'), score: 71 },
          ]}
