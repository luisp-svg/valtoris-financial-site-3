...
const FAMILY_COPY_EN: SpecializedCopyCatalog = {
  ...
  answers: {
    ...
    'goals.buy-home': 'Buy a Home / Homeownership',
  ...
  ui: {
    ...
    resultsHomeBuyerCta: 'Check Your Home Buyer Readiness',
    resultsHomeBuyerCopy:
...
const FAMILY_COPY_ES: SpecializedCopyCatalog = {
  ...
  answers: {
    ...
    'goals.buy-home': 'Comprar una casa / Ser propietario',
  ...
  ui: {
    ...
    resultsHomeBuyerCta: 'Revise su preparación para comprar vivienda',
    resultsHomeBuyerCopy:
      'Vea qué tan preparado está en crédito, ingresos, deudas, ahorros, flujo de efectivo y preparación del enganche.',
