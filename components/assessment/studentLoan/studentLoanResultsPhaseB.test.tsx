...
describe('Student Loan Phase B results', () => {
  it('renders a real score, grade, categories, goal, and booking CTA from valid answers', () => {
    ...
    expect(html).not.toContain('Student Loan Health Score')
    expect(html).toContain('https://studentaid.gov')
    ...
    expect(html).toContain('not a government determination')
    expect(html).toContain('not the U.S. Department of Education or a federal loan servicer')
