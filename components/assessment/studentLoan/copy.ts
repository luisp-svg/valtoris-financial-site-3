...
const STUDENT_LOAN_COPY_EN: SpecializedCopyCatalog = {
  questions: {
    ...
    repayment_plan: 'Are you on a specific repayment plan?',
  ...
  helpers: {
    ...
    repayment_plan: 'If you know the plan name, we will ask which one. You can also say you are not sure.',
    income_household: 'Use your best estimate of adjusted gross income and how many people you support.',
    employment: 'Employment type can affect which federal programs may be worth reviewing later.',
    ...
    current_plan: 'Program names can change. Pick the closest match or Not sure.',
  ...
  fields: {
    ...
    current_plan: 'Current repayment plan',
  ...
  answers: {
    ...
    'current_plan.save': 'SAVE',
    'current_plan.ibr': 'IBR',
    'current_plan.paye': 'PAYE',
    'current_plan.repaye': 'REPAYE',
    'current_plan.icr': 'ICR',
    ...
    'previous_actions.idr': 'Income-driven repayment',
    'previous_actions.pslf': 'PSLF',
    'previous_actions.federal_consolidation': 'Federal consolidation',
    'previous_actions.private_refinancing': 'Private refinancing',
    'previous_actions.borrower_defense': 'Borrower defense',
