...
import type { CreditContactAnswers } from '../../credit/types'

type StepCreditContactProps = {
  contact: CreditContactAnswers
  t: SpecializedCopyFn
  showErrors?: boolean
  onChange: (field: keyof CreditContactAnswers, value: string) => void
}
...
export default function StepCreditContact({
  contact,
  t,
  showErrors = false,
  onChange,
}: StepCreditContactProps) {
