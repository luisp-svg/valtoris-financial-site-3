...
export const homeCopy: Record<PublicLocale, HomeCopy> = {
  en: {
    ...
    serviceInsuranceTitle: 'Insurance & Risk Management',
    serviceInsuranceBody: 'Personal and commercial coverage coordination.',
  ...
  es: {
    ...
    serviceInsuranceTitle: 'Seguros y gestión de riesgo',
    serviceInsuranceBody: 'Coordinación de coberturas personales y comerciales.',
