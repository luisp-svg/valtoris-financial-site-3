...
describe('visual review corrections', () => {
  ...
  it('renders all six diagnostic tools as equal cards and removes Also available', () => {
    ...
    expect(diagnostics.match(/class="site-home-card"/g)?.length).toBe(6)
  ...
  it('aligns Family/Business journey cards with a shared heading and layout', () => {
    ...
    expect(journeys).toContain(`href="${ROUTES.reportCard}"`)
    expect(journeys).toContain(`href="${ROUTES.businessReportCard}"`)
