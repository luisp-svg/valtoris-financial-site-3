...
describe('Phase 3 Student Loan and Credit service pages', () => {
  ...
  it('renders complete Student Loan EN and ES pages with Report Card and Book CTAs', () => {
    ...
    expect(en).toContain('Choose the Level of Support That Fits Your Situation')
    expect(en).toContain('$297')
    expect(en).toContain('$1,200')
    expect(en).toContain('$1,500')
    expect(en).toContain('$300 down, then three payments of $300')
    expect(en).toContain('three payments of $579')
    ...
    expect(es).toContain('Elija el nivel de apoyo que se adapte a su situación')
